    ...
    <section
        ...
        <div>
            @if(session()->has('success'))
                <div
                    class="flex w-full max-w-sm mx-auto overflow-hidden mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                ...
                <form class="space-y-2 space-x-1 " action="{{ url('update-info') }}" method="POST"
                    ...
                    <div class="grid grid-cols-3 gap-6 mt-4 sm:grid-cols-2">
                        <div>
                            ...
                            <input type="text" name="first_nm" value="{{ $data->first_nm }}"
                        ...
                        <div>
                            ...
                            <input type="text" name="last_nm" value="{{ $data->last_nm }}"
                                   class="w-full border-2 border-gray-200 p-3 rounded outline-none focus:border-purple-500">
                        </div>
                        <div>
                            <label class="block mb-1 font-bold text-gray-500">Date of Birth</label>
                            <input type="date" name="dob" value="{{ $data->dob }}"
                                   class="w-full border-2 border-gray-200 p-2.5 rounded outline-none focus:border-purple-500">
                        </div>
                        <div>
                            <label class="block mb-1 font-bold text-gray-500">Telephone Number</label>
                            <input type="text" name="phone_nbr" value="{{ $data->phone_nbr }}"
                                   class="w-full border-2 border-gray-200 p-3 rounded outline-none focus:border-purple-500">
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input type="file" name="profile_img" value="{{ $data->profile_img }}"
                                   class="w-full border-2 border-gray-200 p-3 rounded outline-none focus:border-purple-500">
