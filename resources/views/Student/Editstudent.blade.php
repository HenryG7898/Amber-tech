        ...
        <div class="bg-white m-auto p-8 rounded shadow-2xl w-4/6">
            @if ($data)
                ...
                <form class=" " action="{{ url('update-user') }}" method="post"
                    ...
                    @csrf
                    <div class="space-y-5 space-x-5 grid md:grid-cols-3">
                        <div class="mt-5">
                            <label class="block mb-1 font-bold text-gray-500">First Name</label>
                            <input type="text" value="{{ $data->first_nm }}" name="first_nm"
                        ...
                        <div>
                            ...
                            <input type="text" value="{{ $data->last_nm }}" name="last_nm"
                                   class="w-full border-2 border-gray-200 p-3 rounded outline-none focus:border-purple-500">
                        ...
                        <div>
                            ...
                            <input type="date" value="{{ $data->dob }}" name="dob"
                                   class="w-full border-2 border-gray-200 p-3 rounded outline-none focus:border-purple-500">
                        ...
                        <div>
                            ...
                            <input type="text" value="{{ $data->phone_nbr }}" name="phone_nbr"
                                   class="w-full border-2 border-gray-200 p-3 rounded outline-none focus:border-purple-500">
                    ...
                    <div class="flex justify-end space-x-2">
                        <button type="submit"
                                class="my-6 block w-2/12 bg-green-400 hover:bg-yellow-300 p-3 rounded text-white font-bold text-lg hover:text-yellow-800 transition duration-300">
                            Save
                        </button>
                        <a href="{{ url('student-profile') }}"
                                class="my-6 text-center block w-2/12 bg-red-400 hover:bg-yellow-300 p-3 rounded text-white font-bold text-lg hover:text-yellow-800 transition duration-300">
                            Cancel
                        </a>
                    </div>
                </form>
