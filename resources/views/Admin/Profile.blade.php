                ...
                <div class="md:flex no-wrap md:-mx-2">
                            ...
                            <ul
                                ...
                                <li class="flex items-center py-3">
                                    ...
                                    <span class="ml-auto"><span
                                            class="bg-green-500 py-1 px-2 font-bold rounded text-black text-sm">{{ Auth::user()->user_type }}</span></span>
                                </li>
                                <li class="flex items-center py-3">
                    ...
                    <div class="w-full md:w-9/12 mx-2">
                        ...
                        <span clas="text-white">
                            ...
                            <a href="{{url('Edit-student/'.Auth::user()->id)}}"
                        ...
                        <div class="w-full md:w-12/12 mx-0" style="margin-right: 10%">
                            <div class="bg-white p-5 shadow-lg rounded-sm">
                                ...
                                <form action="{{ url('delete-admin/'.Auth()->user()->id) }}" method="post">
                                    @csrf
