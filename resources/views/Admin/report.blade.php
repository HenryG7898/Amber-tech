        ...
        <div class="px-3 py-4 flex justify-center">
            <table class="w-full text-md bg-white shadow-md rounded mb-4">
                ...
                <tr class="border-b hover:bg-indigo-700 hover:text-white font-bold">
                    <td class="px-10 py-5 p-3 text-center">Rojae Henry</td>
                    <td class="-p-10 mx-26 px-28">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquid consectetur consequuntur, cumque</td>
