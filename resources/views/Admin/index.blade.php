...
{{--                                            </td>--}}
                    ...
                    <div class="swiper-slide">
                        <div class="p-8 text-sm text-gray-800">
                            <h1 class="text-4xl text-gray-700 font-bold leading-none mb-5 text-center">Administrative List</h1>
                            <table class="border w-full text-center shadow-sm">
                                <thead>
                                <tr>
                                    <th class="p-3 text-xs text-gray-900 uppercase font-bold tracking-wide">First Name</th>
...
{{--                <div class="hidden flex swiper-button-next bg-white w-16 h-16 text-xs rounded-full text-pink-500"></div>--}}
